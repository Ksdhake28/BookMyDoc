        ...
        <div className="registration-wrapper">
            <form onSubmit={handleRegister} className="registration-form">
                ...
                {errors.password.state ? (
                    <div className="error-message">
                        Please provide a valid password(Atleat 6 character
                        including[numbers, lower and upper case letters and
                        special characters])
                    </div>
                ) : null}
                ...
                />
                {errors.age.state ? (
                    <div className="error-message">Please provide Age</div>
                ) : null}
                <MDBInput
                    label="Weight"
                    type="number"
